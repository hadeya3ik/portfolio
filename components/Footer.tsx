    ...
    return (
      <div className="w-full bg-accent h-[70vh] text-accent-foreground" style={{ clipPath: "polygon(0% 0%, 100% 0%, 100% 100%, 0 100%)" }}>
        <div className='fixed h-[70vh] bottom-0 py-12'>
          <div className="w-[100vw] text-nowrap sm:text-3xl text-2xl px-4 sm:px-12 flex  pb-12 uppercase items-center justify-between">
          ...
          <div className="w-[100vw] flex px-12 pt-12 gap-8 sm:text-3xl text-2xl">
            <LinkList links={socialLinks} />
            <LinkList links={pageLinks} />
          </div>
          <div className="w-[100vw] text-nowrap sm:text-3xl text-2xl px-4 sm:px-12 flex pt-12 uppercase items-center justify-end">
